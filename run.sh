...
# Step 1.1
python bimeta/load_meta_reads/load_read.py $DATA_PATH/$INPUT_FILE --output $DATA_PATH/output_1_1 -r hadoop --conf-path $CONF_FILE
...
--output $DATA_PATH/output_1_2 -r hadoop --conf-path $CONF_FILE --py-files $UTILS_ZIP

hdfs dfs -get $DATA_PATH/output_1_2/part-00000 $DIC_PATH
...
--output $DATA_PATH/output_2_1 -r hadoop \
--conf-path $CONF_FILE \
--py-files $UTILS_ZIP
